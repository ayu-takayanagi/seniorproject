<template>
  <div class="container">
    <div>
      <div class="title"><h1>Welcome, {{ name }}</h1></div>
        <div class="underTitle">
          <div class="container2">
            <h2>READY TO LEARN SOMETHING NEW?</h2>
            <h3>HOW TO USE</h3>
            <p>Welcome to KIRINUKI! Are you new to this web app? <br> I will take you to the instructions below!</p>
            ...
            <div class="button"><router-link to="/library" class="buttonLink">Get Started >></router-link></div>
          </div>
          <div>
